...
Matrix4.prototype.transformChest = function(angle, offset) {
    return this.templateOscillate(.0015, offset, 1, 0, 0, 0, angle);
}
...
Matrix4.prototype.templateLevitate = function(rate, offset, x, y, z, height1, height2) {
    let influence = Math.cos(rate*globalTime + offset);
    let height = linearMap(influence, -1, 1, angle2, angle1);
